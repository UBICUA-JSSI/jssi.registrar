package jssi.registrar.driver.http;
...
public class HttpDriver implements Driver {
    ...
    public RegisterState register(RegisterRequest registerRequest) throws RegistrationException {
        ...
        String uriString = getRegisterUri().toString();
    ...
    public UpdateState update(UpdateRequest updateRequest) throws RegistrationException {
        // prepare HTTP request
        String uriString = getUpdateUri().toString();
        ...
        if (LOG.isDebugEnabled()) {
            LOG.debug("Retrieved UPDATE STATE for for update request " + updateRequest + " (" + uriString + "): " + updateState);
        }
        // done
        return updateState;
    }
    ...
    public Map<String, Object> properties() throws RegistrationException {
        ...
        if (this.getRegisterUri() != null) {
            httpProperties.put("registerUri", this.getRegisterUri().toString());
        }
        if (this.getUpdateUri() != null) {
            httpProperties.put("updateUri", this.getUpdateUri().toString());
        }
        if (this.getDeactivateUri() != null) {
            httpProperties.put("deactivateUri", this.getDeactivateUri().toString());
        }
        if (this.getPropertiesUri() != null) {
            httpProperties.put("propertiesUri", this.getPropertiesUri().toString());
        }
        ...
        try {
            ...
            if (LOG.isWarnEnabled()) {
                LOG.warn("Cannot retrieve remote properties: " + ex.getMessage(), ex);
            }
